...
BLOG_AUTHOR = "Amit Sethi"  # (translatable)
BLOG_TITLE = "Off Brews and Views"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://amitsethi.in"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://amitsethi.in"
BLOG_EMAIL = "amit.pureenergy@gmail.com"
BLOG_DESCRIPTION = "Amit Sethi's Blog"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('https://twitter.com/dusual', 'My Twitter', 'icon-twitter'),
        ('https://github.com/dusual', 'My Github', 'icon-github'),
    )
}
